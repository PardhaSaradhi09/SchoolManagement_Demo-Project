...
<body>
    ...
    <div class="container">
        <p style="text-align: center;"><b>Show All student</b></p>
    </div>
     <table>
  <thead>
     <tr>
  ...
  <tbody>
    <c:forEach items="${studentList}" var="student">
        <tr>
          ...
          <td><a href="EditStudentServlet?sid=<c:out value='${student.sid}' />">Edit</a></td>
          <td><a href="DeleteStudentServlet?sid=<c:out value="${student.sid}" />">Delete</a></td>
          <td><a href="AddCourseServlet?sid=<c:out value="${student.sid}" />">Add</a></td>
