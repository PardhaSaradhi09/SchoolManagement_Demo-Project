		...
		<div class="form">
		     <div class="inputfield">
				 <input type="hidden" class="input"
					name="sid" value='<c:out value="${student.sid}" />'>
			</div>
		  
			<div class="inputfield">
				<label>Course Name</label> <input type="text" class="input"
					name="course_name" value='<c:out value="${student.course_name}" />'>
			</div>
			<div class="inputfield">
				<label>Course Mentor</label> <input type="text" class="input"
					name="course_mentor" value='<c:out value="${student.course_mentor}" />'>
			</div>

		     <div class="inputfield">
				<label>Course Duration</label> <input type="number" class="input" name="course_duration"
					value='<c:out value="${student.course_duration}" />'>
			</div>
